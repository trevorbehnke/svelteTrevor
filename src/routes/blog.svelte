...
<main class="pt-16">
	...
	<div class="flex flex-row justify-between my-6 items-center">
		...
		<div>
			<input
				class="focus:border-primary-500 outline-none focus:outline-none text-gray-900 dark:text-gray-100 placeholder-gray-500 bg-gray-100 dark:bg-gray-900 rounded-md text-md p-2 border-2"
